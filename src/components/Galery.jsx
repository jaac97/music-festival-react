        ...
        <section className="galery" >
            ...
            <div className="photos">
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/1.jpg" lazyalt="thumb/1"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/2.jpg" lazyalt="thumb/2"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/3.jpg" lazyalt="thumb/3"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/4.jpg" lazyalt="thumb/4"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/5.jpg" lazyalt="thumb/5"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/6.jpg" lazyalt="thumb/6"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/7.jpg" lazyalt="thumb/7"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/8.jpg" lazyalt="thumb/8"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/9.jpg" lazyalt="thumb/9"/>
                </picture>
                <picture>
                    ...
                    <img loading="lazy" decoding="async" src="img/grande/10.jpg" lazyalt="thumb/10"/>
                </picture>
            </div>
        </section>
     );
